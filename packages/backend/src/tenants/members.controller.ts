...
export class MembersController {
  constructor(
    ...
    private readonly memberAppAccessService: MemberAppAccessService,
  ) {}
  ...
  async getAppUsers(
    ...
    return this.memberAppAccessService.getAppUsers(tenantId, appId);
  }
  ...
  async getAvailableMembers(
    ...
    return this.memberAppAccessService.getMembersWithoutAppAccess(tenantId, appId);
  }
  ...
  async grantAccess(
    ...
    return this.memberAppAccessService.grantAppAccess(
      tenantId,
      appId,
      dto.membershipIds,
      dto.roleId,
  ...
  async updateAccess(
    ...
    return this.memberAppAccessService.updateAppRole(tenantId, appId, membershipId, dto.roleId);
  }
  ...
  async removeAccess(
    ...
    return this.memberAppAccessService.removeAppAccess(tenantId, appId, membershipId);
  }
  ...
  async toggleAppAccess(
    ...
    return this.memberAppAccessService.toggleAppAccess(
      tenantId,
      appId,
      dto.userId,
      dto.enable,
